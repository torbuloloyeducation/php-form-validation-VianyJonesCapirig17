...
<div class="form-container">
    ...
    <p class="required-note">
        Fields marked with <span style="color:var(--error-red)">*</span> are required.
    </p>

    <!-- Attempt display -->
    <p class="required-note">Submission attempt: <?= $attempt ?></p>
    ...
    <form method="post" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>">
        ...
        <div class="field-row">
            <label>Email *</label>
            <input type="text" name="email" placeholder="example@email.com" value="<?= $email ?>">
        ...
        <div class="field-row">
            <label>Comment</label>
            <textarea name="comment" placeholder="Write your message here..."><?= $comment ?></textarea>
        </div>
    ...
    <div class="output-box">
        ...
        <?php elseif ($submitted): ?>
            <p style="color:var(--error-red);">Please fix the errors.</p>
        <?php else: ?>
            <p style="font-style: italic;">Results will appear here.</p>
        <?php endif; ?>
    </div>
